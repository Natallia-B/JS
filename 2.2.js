/**
 * Created by nokatami on 10/04/17.
 */
    ...
    let result = arr.map((elem) => {
        for (el in elem) {
            ...
            if (el == 'name') {
                ...
                elem[el] = +elem[el] * 0.01;

                    return elem;
                }

            let calcul = (elem.rate - elem.performance_score);
            elem.calc = calcul;
...
console.log(NewArr(criteria_list));
